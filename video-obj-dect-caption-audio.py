...
output = get_completion("/home/pi/pot-hole2.jpg")
...
while True:
    ...
    if get_frame_caption > 100:
        output = get_completion(frame)
        os.system("echo `/usr/bin/flite -voice slt -t \"" + output[0]['generated_text'] + "\"`")
        get_frame_caption = 0
